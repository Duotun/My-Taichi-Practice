...
import taichi as ti
from ray import Ray
from vector import random_in_unit_disk, random_number_range, unit_vector
from vector import vec3f

@ti.data_oriented
class Camera:
    def __init__(self, lookfrom, lookat, vup = ti.Vector([0.0, 1.0, 0.0], dt = ti.f32), vfov = 60.0, aspect_ratio=16.0/9.0, aperture=2.0, focus_dist = 6.0, time_0=0.0, time_1=0.0):
        self.vfov = vfov;
    ...
    def get_ray(self, s, t):
        ...
        r = Ray(origin=self.origin + offset, direction=self.lower_left_corner + s*self.horizontal + t*self.vertical- self.origin - offset, tm=random_number_range(self.time_0, self.time_1));
        return r;
